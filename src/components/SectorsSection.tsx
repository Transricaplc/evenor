    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 text-gold text-sm font-medium mt-5 self-start min-h-11 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold before:absolute before:absolute before:inset-0 before:content-['']"
        >
