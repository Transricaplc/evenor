          ...
          <div className="container-wide">
            <div className="grid lg:grid-cols-[440px_1fr] gap-12 lg:gap-20 items-start max-w-6xl mx-auto">
              ...
              <motion.div
                ...
                transition={{ duration: 0.7 }}
              >
                <p className="gold-label gold-ink gold-ink mb-4">Letter from the CEO</p>
        ...
        <section className="section-pad bg-smoke">
          <div className="container-wide">
            <div className="text-center mb-14 max-w-3xl mx-auto">
              <p className="gold-label gold-ink gold-ink mb-4">Governance</p>
        ...
        <section className="py-20 bg-offwhite">
          <div className="container-wide max-w-3xl mx-auto text-center">
            <div className="border-t border-b border-navy/15 py-10">
              <p className="gold-label gold-ink gold-ink mb-4">Wider Bench</p>
